...
const experience = [
  {
    ...
    summary:
      "Building and shipping real-world projects with MERN stack.",
    points: [
      "Built scalable web applications using React.js, Next.js, Node.js, Express.js, and MongoDB with performance optimization techniques, decreasing load times by 40%.",
      "Collaborated with designers and product managers in Agile sprints to translate ideas into production-ready components, achieving 95% sprint delivery accuracy and reducing rework by 20%.",
      "Developed 50+ RESTful and GraphQL APIs using Node.js, Express.js, and MongoDB/PostgreSQL, improving response time by 30% and enhancing frontend reliability.",
      "Integrated backend services into the frontend using REST and GraphQL, while managing complex application state with Redux Toolkit, reducing manual data handling by 45%.",
